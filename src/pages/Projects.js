...
const PROJECT_DATA = [
  ...
  },
  {
    ...
    shortDescription: "The site you are currently viewing. Portfolio Site for Dan Kercher/Winking Cat Studio. Made with React, Material-UI, EmailJS.",
  ...
  },
  {
    ...
    shortDescription: "Raspberry Pi Flask server with connected servos to roll dice, site features camera feed and dice rolling motor controls.",
    longDescription:
...

  {
    ...
    shortDescription: "A steganography and time stamping solution to authenticate digital artwork authorship. Made with JavaScript and Bootstrap.",
  ...
  },
  {
    ...
    type: "Webdev",
    image: "/js_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/ts-phaser3-browser-game-monkey-platformer",
    shortDescription: "TypeScript Phaser3 browser platformer game in which you control a monkey and collect bananas across three levels.",
    longDescription: "TypeScript Phaser3 browser platformer game in which you control a monkey and collect bananas across three levels.",
  },
  {
    id: "p15",
    ...
    shortDescription: "Front-end for a dungeons and dragons character database built in SQL Server 2017. The database has since been retired.",
  ...
  },
  {
    ...
    type: "Python",
    image: "/python_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/kmeans-cv-segmentation-confidence",
    shortDescription: "K means color clustering solution for computer vision image processing and matching confidence.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: "Learning Project: CoAP server running on a Raspberry Pi with room temperature sensor. Uses CoAPthon3 library.",
    longDescription:
  ...
  },
  {
    ...
    type: "C++",
    image: "/c++_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/design-patterns-tree-based-infix-to-postfix-calculator",
    shortDescription: "Tree based infix to postfix calculator demonstrating the Command, Abstract Factory, Wrapper Facade software design patterns.",
  ...
  },
  {
    ...
    type: "C++",
    image: "/c++_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/design-patterns-node-based-infix-to-postfix-calculator",
    shortDescription: "Node based infix to postfix calculator demonstrating the Composite, Visitor, Builder software design patterns.",
    longDescription: "Node based infix to postfix calculator demonstrating the Composite, Visitor, Builder software design patterns. A basic expression evaluator using a Stack and Infix to Postfix algorithm. To improve the design it uses the Composite, Visitor, Builder, Iterator, and Wrapper Facade software design patterns",
  },
  {
    id: "p10",
    ...
    shortDescription: "Grid based JavaScript engine for rogue-like, tabletop rpg simulator, turn-based RPG overworld, strategy RPG, and more.",
  ...
  },
  {
    ...
    type: "Webdev",
    image: "/js_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/choose-your-own-adventure-browser-game-dinos",
    shortDescription: "Text game based on DnD (SRD) featuring an anthropomorphic dinosaur who communicates by producing scents based on its emotions.",
  ...
  },
  {
    ...
    type: "Webdev",
    image: "/js_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/js-canvas-primitives-browser-game-maze",
    shortDescription: "A maze browser game made with JavaScript using only line draw 2D primitives. Navigate the interactive maze before time runs out.",
  ...
  },
  {
    ...
    type: "Python",
    image: "/python_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/iot-rpi-led-keypad-servo-demo",
    shortDescription: "Learning Project: Raspberry Pi GPIO demo script for working with LEDs, matrix keypads, and servos.",
    longDescription:
  ...
  },
  {
    ...
    gitLink: "https://github.com/winkingcatstudios/cv-pattern-recognition-dental-segmentation",
    shortDescription: "Computer vision pattern recognition MATLAB script for computer guided tooth segmentation from radiographic images.",
    longDescription: "Computer vision MATLAB script for computer guided tooth segmentation from radiographic images based on motivating papers by Anil K Jain, and Hong Chen from the Deptarment of Computer Science and Engineering at Michigan State University.",
  },
  {
    id: "p5",
    ...
    type: "MATLAB",
    image: "/matlab_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/cv-distance-based-hand-feature-vector",
    shortDescription: "Computer vision MATLAB script to calculate the distance-based hand feature vector using Euclidean distance as a metric.",
    longDescription: "Computer vision MATLAB script to calculate the distance-based hand feature vector using Euclidean distance as a metric.",
  },
  {
    id: "p4",
    ...
    type: "C++",
    image: "/c++_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/huffman-codes-greedy-algorithm",
    shortDescription: "Greedy algorithm solution to generate Huffman codes for data compression. Algorithm provided along with demo driver code.",
    longDescription: "Greedy algorithm solution to generate Huffman codes as used in famous data compression technique.",
  },
  {
    id: "p3",
    ...
    type: "C++",
    image: "/c++_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/longest-increasing-subsequence-dynamic-programming",
    shortDescription: "Dynamic programming solution to generate the longest increasing subsequence. Algorithm provided along with demo driver code.",
    longDescription: "Dynamic programming solution to generate the longest increasing subsequence.",
  },
  {
    id: "p2",
    ...
    type: "C++",
    image: "/c++_stock.jpeg",
    gitLink: "https://github.com/winkingcatstudios/peak-search-divide-and-conquer",
    shortDescription: "Divide and conquer solution to generate the index of the peak array element. Algorithm provided along with demo driver code.",
    longDescription: "Divide and conquer solution to generate the index of the peak array element.",
  },
  {
    id: "p1",
    ...
    shortDescription: "Learning Project: C# basics refresher and core features template. Can serve as a template base for small Forms projects.",
    longDescription: "Learning Project: C# basics refresher and core features template. This project was done to learn the basic features of C# Forms applications and can serve as a template base for small Forms projects.",
  },
];
